...
> **Muse 不替你放下手机，只提醒你想起还有什么值得去做。**

Muse 的目的不是通过强制锁定或限制应用来控制你使用手机。手机本身不是问题，真正容易被忽略的是：我们常常在没有明确目的的情况下，一次又一次地向下滑动，把时间交给惯性。

因此，Muse 选择持续提醒，而不是强制控制。当提醒出现时，它只是邀请你停顿片刻，想一想：

**除了继续刷下去，此刻是否还有更值得做的事情？**

也许是完成一项计划、读几页书、陪伴家人、出去走走，或者只是让自己真正休息一会儿。

是否继续使用手机，决定权始终在你手里。Muse 想做的，只是帮助你从“无意识地刷”回到“有意识地选择”。
